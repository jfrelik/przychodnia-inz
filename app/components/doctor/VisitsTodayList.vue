<script lang="ts" setup>
	...
	const getContactLabel = (visit: Visit) =>
		visit.patientEmail ?? 'Brak danych kontaktowych';
...
<template>
	<div class="flex flex-col gap-4">
		<div class="flex items-center justify-between">
			<h2 class="text-2xl font-bold">Wizyty na dziś</h2>
			<UButton
				v-if="!pending && !error"
				variant="soft"
				color="neutral"
		...
		<div v-else>
			...
			>
				...
				<p class="text-sm text-gray-500">Brak wizyt na dziś.</p>
			</div>
					...
					<div class="flex items-center gap-4">
						...
						<div class="flex flex-1 flex-col gap-1">
							...
							>
								...
								<span>{{ getLocationLabel(visit) }}</span>
