...
defineRouteMeta({
	openAPI: {
		operationId: 'Auth_RegisterPatient',
		tags: ['Auth'],
		summary: 'Register new patient',
		description:
			'Creates a new user account with patient role, creates patient profile, and sends verification email.',
		requestBody: {
			required: true,
			content: {
				'application/json': {
		...
		responses: {
			...
			409: { description: 'Email or PESEL already exists' },
